...
const CprogrammingApp = () => {
  const topics = [
    ...
    { name: 'Arrays', path: 'co2/Increment-decrement-operators', component: Co2topic1page },
    { name: 'Pointers', path: 'co2/Iterative-Statements', component: Co2topic2page },
    { name: 'Strings', path: 'co2/Loops', component: Co2topic3page },
    { name: 'Structures and Unions', path: 'co2/Nested-Loops', component: Co2topic4page },
    { name: 'Dynamic Memory Allocation', path: 'co2/Bitwise-Operators-I', component: Co2topic5page },
    { name: 'File Handling', path: 'co2/Bitwise-Operators-II', component: Co2topic6page },
    { name: 'Command Line Arguments', path: 'co2/Expression-Evaluation-Rules', component: Co2topic7page },
    { name: 'Preprocessor Directives', path: 'co2/Operator-Precedency', component: Co2topic8page },
    { name: 'Bitwise Operators', path: 'co2/Recursion', component: Co2topic9page },
    { name: 'Recursion', path: 'co2/Problem-Solving-with-Recursion', component: Co2topic10page },

    // CO3 - Advanced Concepts
    { name: 'Data Types II', path: 'co3/Data-Types-II', component: Co3topic1page },
    { name: 'Searching and Sorting', path: 'co3/Command-Line-Arguments', component: Co3topic2page },
    { name: 'File Processing', path: 'co3/Strings-and-String-Library', component: Co3topic3page },
    { name: 'Multidimensional Arrays', path: 'co3/Arrays-Creation-Insertion', component: Co3topic4page },
    { name: 'Command Line Arguments and Environment Variables', path: 'co3/Bubble-Sort', component: Co3topic5page },
    { name: 'Dynamic Data Structures', path: 'co3/Linear-Search', component: Co3topic6page },
    { name: 'Bit Manipulation', path: 'co3/Binary-Search', component: Co3topic7page },
    { name: 'Error Handling', path: 'co3/Dynamic-Memory-Allocation', component: Co3topic8page },


    // CO4 - Advanced Topics
    { name: '2D-Arrays-Creation-Insertion', path: 'co4/2D-Arrays-Creation-Insertion', component: Co4topic1page },
    { name: 'Thread Synchronization', path: 'co4/2D-Arrays-Matrixes', component: Co4topic2page },
    { name: 'Interprocess Communication', path: 'co4/Matrix-Algebra-with-Arrays', component: Co4topic3page },
    { name: 'Socket Programming', path: 'co4/Structures', component: Co4topic4page },
    { name: 'Debugging and Profiling', path: 'co4/Array-of-Structures', component: Co4topic5page },
    { name: 'Code Optimization', path: 'co4/Structure-Pointers', component: Co4topic6page },
    { name: 'Unit Testing', path: 'co4/Stacks-using-Arrays', component: Co4topic7page },
