          ...
          <div className="co-sidebar">
           ...
           <div className="topic-content">
            <div className="topic-content-head">
                <h1>Loops</h1>
                <p>In this page you will learn about Loops
                   in detail
                </p>
            </div>
            <div className="c2t-common-intro">
              <p>Loops are programming constructs that allow you to repeat a block of code multiple times until a specific condition is met. They are used to automate repetitive tasks, iterate over collections of data, or execute a set of instructions repeatedly.</p>
            </div>
            <div className="c2t-common-container">
              <p> <b>Initialization :</b>  This step initializes the loop control variable(s) with an initial value. It is typically executed only once before the loop starts.</p>
              <p> <b>Condition :</b> The condition is evaluated before each iteration of the loop. If the condition is true, the loop body is executed. If the condition is false, the loop terminates, and control passes to the next statement after the loop.</p>
              <p> <b>Update:</b> After each iteration, the loop control variable(s) are updated according to the specified increment/decrement rules. This step prepares the loop for the next iteration.</p>
              <h3>for loop :</h3>
