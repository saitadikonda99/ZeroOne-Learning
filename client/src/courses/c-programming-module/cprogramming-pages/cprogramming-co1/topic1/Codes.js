export const codeArr = [
    ...
    {
      code: `// Function to calculate the average of two numbers
  ...
  int calculateFactorial(int n) {
    ...
    {
      code: `// Function to check if a number is even or odd
  void checkEvenOrOdd(int num) {
    ...
    {
      code: `// Function to calculate the area of a rectangle
